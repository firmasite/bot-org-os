...
3. Follow `BOOTSTRAP.md` fully — including **Step 6 Orient Core Team** (Core Team post + 1:1 wakes for the brief; each specialist's **first Core Team message** must be a self-intro in the room — not only a 1:1 ack).

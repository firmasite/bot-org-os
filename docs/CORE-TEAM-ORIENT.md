# Core Team orientation (post-install)

Chief runs this once after Core Team is created (BOOTSTRAP Step 6).
...
- Chief routes; phase owners do not DIY other phases
- Chat = control; files = bus under `workspace/{analysis,planning,solutioning,implementation,handoffs,org}/`
...
Chief’s day-one welcome should also suggest: Right-click **Chief** in the Grok Bot sidebar → **Pin**.
